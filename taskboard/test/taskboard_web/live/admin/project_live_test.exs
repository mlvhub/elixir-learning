defmodule TaskboardWeb.Admin.ProjectLiveTest do
  use TaskboardWeb.ConnCase

  import Phoenix.LiveViewTest
  import Taskboard.Core.ProjectsFixtures
  ...
  describe "Index" do
    ...
    test "saves new project", %{conn: conn} do
      ...
      assert_patch(index_live, ~p"/admin/projects")
  ...
  describe "Show" do
    ...
    test "updates project within modal", %{conn: conn, project: project} do
      ...
      assert_patch(show_live, ~p"/admin/projects/#{project}")
