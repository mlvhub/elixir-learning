defmodule TaskboardWeb.Router do
  ...
  scope "/auth", TaskboardWeb.Auth, as: :auth do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TaskboardWeb.Auth.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/auth", TaskboardWeb.Auth, as: :auth do
    ...
    live_session :require_authenticated_user,
      on_mount: [{TaskboardWeb.Auth.UserAuth, :ensure_authenticated}] do
  ...
  scope "/auth", TaskboardWeb.Auth, as: :auth do
    ...
    live_session :current_user,
      on_mount: [{TaskboardWeb.Auth.UserAuth, :mount_current_user}] do
